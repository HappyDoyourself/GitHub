...
import cn.com.jiuyao.util.payments.alipayWap.httpClient.HttpProtocolHandler;
import cn.com.jiuyao.util.payments.alipayWap.httpClient.HttpRequest;
import cn.com.jiuyao.util.payments.alipayWap.httpClient.HttpResponse;
import cn.com.jiuyao.util.payments.alipayWap.httpClient.HttpResultType;
...
public class AlipaySubmit {
     ...
     * @return 签名结果字符串
     */
	public static String buildRequestMysign(Map<String, String> sPara,String key,String input_charset,String sign_type) {
     ...
     * @return 要请求的参数数组
     */
    private static Map<String, String> buildRequestPara(Map<String, String> sParaTemp,String key,String input_charset,String sign_type) {
        //除去数组中的空值和签名参数
        Map<String, String> sPara = AlipayCore.paraFilter(sParaTemp);
        //生成签名结果
        String mysign = buildRequestMysign(sPara,key,input_charset,sign_type);
    ...
    public static String buildRequest(String ALIPAY_GATEWAY_NEW, Map<String, String> sParaTemp,
                                      String strMethod, String strButtonName,String key , String input_charset,String sign_type) {
        //待请求参数数组
        Map<String, String> sPara = buildRequestPara(sParaTemp,key,input_charset,sign_type);
    ...
    public static String buildRequest(String ALIPAY_GATEWAY_NEW, Map<String, String> sParaTemp, String strMethod,
                                      String strButtonName, String strParaFileName,String key,String input_charset,String sign_type) {
        //待请求参数数组
        Map<String, String> sPara = buildRequestPara(sParaTemp,key,input_charset,sign_type);
        List<String> keys = new ArrayList<String>(sPara.keySet());
    ...
    public static String buildRequest(String ALIPAY_GATEWAY_NEW, String strParaFileName, String strFilePath,
                                      Map<String, String> sParaTemp, String key, String input_charset,String sign_type) throws Exception {
        //待请求参数数组
        Map<String, String> sPara = buildRequestPara(sParaTemp,key,input_charset,sign_type);
     ...
     * @throws Exception 
     */
    public static String getRequestToken(String text,String key ,String input_charset) throws Exception {
    	...
    	if (paraText.get("res_data") != null) {
    		...
    		if(AlipayConfig.sign_type.equals("0001")) {
    			res_data = RSA.decrypt(res_data, key, input_charset);
    		}
