...
public class AlipayNotify {
     ...
     * @return 验证结果
     */
    public static boolean verifyReturn(Map<String, String> params,String key , String input_charset,String sign_type) {
	    String sign = "";
	    //获取返回时的签名验证结果
	    if(params.get("sign") != null) {sign = params.get("sign");}
	    //验证签名
	    boolean isSign = getSignVeryfy(params, sign, true,key,input_charset,sign_type);
     ...
     * @return 验证结果
     */
    public static boolean verifyNotify(Map<String, String> params,String key,String input_charset,String partner,String sign_type) throws Exception {
	    ...
	    String sign = "";
	    if(params.get("sign") != null) {sign = params.get("sign");}
	    boolean isSign = getSignVeryfy(params, sign,false,key,input_charset,sign_type);
     ...
     * @return 生成的签名结果
     */
	private static boolean getSignVeryfy(Map<String, String> Params, String sign, boolean isSort,String key,String input_charset,String sign_type) {
...
//        String partner = AlipayConfig.partner;
    ...
    */
     ...
     * @return 验证结果
     */
    public static boolean verify(Map<String, String> params,String partner,String key,String input_charset,String sign_type) {
