package cn.com.jiuyao.util.payments.weixin.client;
...
public class ZxingQrCode {
    ...
    public static void encodeQRCodeImage(String content, String charset,
        ...
        MatrixToImageWriter.writeToStream(bitMatrix, imagePath.substring(imagePath.lastIndexOf(".") + 1), new FileOutputStream(new File(imagePath)), config);
    }
