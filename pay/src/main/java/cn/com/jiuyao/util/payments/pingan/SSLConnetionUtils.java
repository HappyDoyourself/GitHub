...
public class SSLConnetionUtils {
	...
	private static final String yiQianbaoHost = "114.80.86.110";
	private static final int HTTPS_PORT = 443;

	// 要导入的证书的别名
	private static final String certFileAlias = "epaysecure";
	...
	public static void importCertificate(String jksPath, String jksPassword) {
		try {
			Certificate certificate = getYiQianBaoCertificate();
...
//				System.out.println("Your imported certificate " + alias);
	 ...
	 * @return
	 */
	public static Certificate getYiQianBaoCertificate() {
		try {
			...
			SSLSocket socket = (SSLSocket) factory.createSocket(yiQianbaoHost, HTTPS_PORT);
			...
			throw new RuntimeException("Exception while get epay certificate.", e);
		}
	}
