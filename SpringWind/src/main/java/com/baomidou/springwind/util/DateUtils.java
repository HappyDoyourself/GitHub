...
public class DateUtils {
	...
	public static long getLongDate(Date date) {
		return DateUtils.dateToLong(getDateParser("yyyy-MM-dd HH:mm:ss").format(date));
	}
	 ...
	 * @return
	 */
	public static String getYesterdayStr(Date date,String formart){
		String dateStr = "";
		if (null!=date) {
			Long dateLong = date.getTime();
			Long yesterdayLong = dateLong - 24*60*60*1000;
			SimpleDateFormat sdf= new SimpleDateFormat(formart);
			dateStr = sdf.format(new Date(yesterdayLong));
		}
	...
	public static void main(String[] args) {
		...
		// }
		//
		getAfterByMinuties(new Date(),5);
		DateUtils.getYesterdayStr(new Date(),"yyyy-MM-dd");
		//System.out.println(DateUtils.getYesterdayStr(new Date());
		//24*60*60*1000
	 ...
	 * @return
	 */
	public static Date getAfterByMinuties(Date date, int minus){
     Calendar curr =   Calendar.getInstance();
     curr.setTime(date);
     curr.add(Calendar.MINUTE,minus);
     return curr.getTime();
	}
