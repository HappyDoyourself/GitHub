...
//			formparams.add(new BasicNameValuePair("productIdsStr", "10,11,12,13"));  
			...
			HttpPost httppost = new HttpPost(host+"/product/saveOrUpdate/70");  
...
//			String host = "192.168.90.207:8080/search-api-web";
			String host = "192.168.1.214:8085/search-api-web";
			
			System.out.println("======get===");
//			String productName = URLEncoder.encode("欧姆龙", "UTF-8");
			String productName = URLEncoder.encode("Innisfree", "UTF-8");
//			String productName = URLEncoder.encode("胶囊Ⅱ", "UTF-8");
			//get 
			CloseableHttpClient httpclient = HttpClients.createDefault();
			URI uri = new URIBuilder() 
					.setScheme("http") 
...
//			HttpPost httppost = new HttpPost("http://192.168.100.88:8080/shopping-api-mobile/shopping/removeProductCart.html");  
	...
	@Test
	public void testOneSave2() {
		try {
			
			String host = "http://localhost:8080/search-api-mobile";
			...
			formparams.add(new BasicNameValuePair("couponId", "190"));
			
			UrlEncodedFormEntity entity = new UrlEncodedFormEntity(formparams, Consts.UTF_8);
			
			HttpPost httppost = new HttpPost(host+"/search/wapsearch");  
			httppost.setEntity(entity); 
